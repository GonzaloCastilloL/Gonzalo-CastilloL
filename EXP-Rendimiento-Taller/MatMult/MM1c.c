...
* Ajuste: Modificaciones al programa para realizar experimento de ejecución
* en cluster SIN MPI
*************************************************************************/
...
/*Validación de las varianbles recibidas por el programa, para garantizar la consistencia*/
...
#pragma omp parallel
/*Parametrización para permitir que el programa se ejecute en paralelo utilizando openMP*/
...
#pragma omp for
/* Logica para el calculo del producto de dos matrices, utilizando la multiplicación de Filas * Columnas */
    for (i=0; i<SZ; i++)
        for (j=0; j<SZ; j++) {
            double *pA, *pB, S;
            S=0.0; 
